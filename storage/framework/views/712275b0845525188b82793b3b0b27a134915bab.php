...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <form role="form" method="POST" action="<?php echo e(route('cart-product.update')); ?>">
          ...
          <!-- /.box-header -->               
            ...
            <div class="box-body">
              ...
              <?php endif; ?>                
                ...
                <div class="form-group col-md-6">
                  <label>Hướng </label>
                  <input type="text" class="form-control" name="direction" id="direction" value="<?php echo e(old('direction', $detail->direction)); ?>">
                </div>
                ...
                <div class="form-group col-md-6">
                  <label>Lầu </label>
                  <input type="text" class="form-control" name="floor" id="floor" value="<?php echo e(old('floor', $detail->price)); ?>">
                </div>
                ...
                <div class="form-group col-md-6">
                  ...
                  <input type="text" class="form-control" name="hoa_hong" id="hoa_hong" value="<?php echo e(old('hoa_hong', $detail->hoa_hong)); ?>">
                </div> 
                <div class="form-group col-md-12">
                  <label for="email">Trạng thái </label>
                  <select class="form-control" name="status" id="status">                                
                    <option value="1" <?php echo e(1 ==  old('status', $detail->status) ? "selected" : ""); ?>>Chưa bán</option>
                    <option value="2" <?php echo e(2 ==  old('status', $detail->status) ? "selected" : ""); ?>>Đã bán</option>
                    <option value="3" <?php echo e(3 ==  old('status', $detail->status) ? "selected" : ""); ?>>Đã cọc</option>
                  </select>
                </div>
                <!-- textarea -->
                <div class="form-group col-md-12">
                  <label>Ghi chú</label>
                  <textarea class="form-control" rows="3" name="notes" id="notes"><?php echo e(old('notes', $detail->notes)); ?></textarea>
                </div>            
