...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="<?php echo e(route('pro-content.index', ['project_id' => $project_id])); ?>"></a></li>
  ...
  <section class="content">
    ...
    <form role="form" method="POST" action="<?php echo e(route('pro-content.update')); ?>">
    <div class="row">
      <!-- left column -->
        ...
        <div class="box box-primary">
          ...
          <!-- /.box-header -->               
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="tab_id" id="tab_id">
                    ...
                    <?php if( $tabList->count() > 0): ?>
                      ...
                      <option value="<?php echo e($value->id); ?>" <?php echo e($value->id == old('tab_id', $detail->tab_id) ? "selected" : ""); ?>><?php echo e($value->name); ?></option>
                      <?php endforeach; ?>
                    <?php endif; ?>
                  </select>
                </div>                           
            ...
            <div class="box-footer">
              ...
              <a class="btn btn-default btn-sm" class="btn btn-primary btn-sm" href="<?php echo e(route('pro-content.index', ['project_id' => $project_id])); ?>">Hủy</a>
            </div>
