        ...
        <div class="box box-primary">
          ...
          <form role="form" method="POST" action="<?php echo e(route('cate.update')); ?>">
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                  ...
                  <select class="form-control req" name="parent_id" id="parent_id">
                      ...
                      <?php echo e(old('parent_id', $detail->parent_id) == $value->id ? "selected" : ""); ?>                           
            ...
            <div class="box-footer">
              ...
              <a class="btn btn-default btn-sm" class="btn btn-primary btn-sm" href="<?php echo e(route('cate.index')); ?>">Hủy</a>
            </div>
