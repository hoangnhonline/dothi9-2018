...
<article class="block-breadcrumb-page">
	<ul class="breadcrumb">	
		...
		<li class="active"><?php echo e($rs->name); ?></li>
	</ul>
</article>
	<article class="block block-news-new block-news-cate clearfix">
		<div class="block-cate-title"><h1><?php echo $rs->name; ?> tại Việt Nam</h1></div>
		<?php if(isset($seo['custom_text'])): ?>
		...
		<div class="block-searchresult">
			<h2>Tìm kiếm theo các tiêu chí: <b style="color: #37a344;"><?php echo $rs->name; ?></b></h2>
