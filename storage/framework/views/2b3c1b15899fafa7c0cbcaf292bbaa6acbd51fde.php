...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="<?php echo e(route('landing-projects.index')); ?>">Dự án</a></li>
      ...
      <div class="col-md-8">
        ...
        <div class="box box-primary">
          ...
          <!-- /.box-header -->               
            ...
            <div class="box-body">
              ...
              <?php endif; ?>                                                   
                ...
                <div class="form-group" style="margin-top:10px;margin-bottom:10px">  
                  ...
                  <div class="col-md-9">
                    <img id="thumbnail_logo" src="<?php echo e($detail->logo_url ? Helper::showImage($detail->logo_url ) : URL::asset('backend/dist/img/img.png')); ?>" class="img-thumbnail" width="145" height="145">
                 ...
                 <div class="form-group">
                  ...
                  <?php $i = 0; ?>
                    ...
                    <li style="list-style:none">
                      <input type="checkbox" name="tab[]" id="tab_<?php echo e($i); ?>" value="<?php echo e($tab->id); ?>" 
                      <?php echo e(in_array($tab->id, old('tab', $tabSelected)) ? "checked" : ""); ?>

                      >
                      <label for="tab_<?php echo e($i); ?>"><?php echo e($tab->name); ?></label>
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" rows="3" name="address" id="address"><?php echo e(old('address', $detail->address)); ?></textarea>
                </div>
                <div class="form-group">
                  <label>Địa chỉ liên hệ</label>
                  <textarea class="form-control" rows="3" name="address_contact" id="address_contact"><?php echo e(old('address_contact', $detail->address_contact)); ?></textarea>
                </div>  
                <div class="form-group">                  
                  <label>Điện thoại</label>                  
                  <input type="text" class="form-control" name="phone_contact" id="phone_contact" value="<?php echo e(old('phone_contact', $detail->phone_contact)); ?>">
                </div>  
                <div class="form-group">                  
                  <label>Email</label>                  
                  <input type="text" class="form-control" name="email_contact" id="email_contact" value="<?php echo e(old('email_contact', $detail->email_contact)); ?>">
                </div>  
            </div>          
            ...
            <input type="hidden" name="logo_url" id="logo_url" value="<?php echo e($detail->logo_url); ?>"/>          
            <input type="hidden" name="logo_name" id="logo_name" value="<?php echo e($detail->logo_name); ?>"/>
            <div class="box-footer">
              <button type="submit" class="btn btn-primary btn-sm">Lưu</button>
              <a class="btn btn-default btn-sm" class="btn btn-primary btn-sm" href="<?php echo e(route('landing-projects.index')); ?>">Hủy</a>
            </div>
