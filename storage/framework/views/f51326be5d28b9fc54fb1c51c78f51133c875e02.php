    ...
    <section class="content">
        <div class="row">
            <div class="col-md-12">
                ...
                <?php endif; ?>
                <a href="<?php echo e(route('cate.create', ['estate_type_id' => $estate_type_id, 'type' => $type])); ?>" class="btn btn-info btn-sm" style="margin-bottom:5px">Tạo mới</a>
                        ...
                        <form class="form-inline" id="searchForm" role="form" method="GET" action="<?php echo e(route('cate.index')); ?>">   
                            ...
                            <div class="form-group">
                                <select class="form-control" name="estate_type_id" id="estate_type_id">
                                    ...
                                    <?php echo e($estate_type_id == $value->id ? "selected" : ""); ?>                        
                        ...
                        <table class="table table-bordered" id="table-list-data">
                            ...
                            <tbody>
                                ...
                                <tr id="row-<?php echo e($item->id); ?>">
                                    ...
                                    <td>
                                      <img class="img-thumbnail lazy" width="100" data-original="<?php echo e($item->image_url ? Helper::showImage($item->image_url) : URL::asset('backend/dist/img/no-image.jpg')); ?>" alt="Nổi bật" title="Nổi bật" />
                                    </td>
                                    <td>
                                        <a href="<?php echo e(route( 'cate.edit', [ 'id' => $item->id ])); ?>"><?php echo e($item->name); ?>
