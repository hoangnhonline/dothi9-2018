...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="<?php echo e(route('estate-type.index')); ?>">Danh mục</a></li>
  ...
  <section class="content">
    <a class="btn btn-default btn-sm" href="<?php echo e(route('estate-type.index')); ?>" style="margin-bottom:5px">Quay lại</a>
    ...
    <div class="row">
      ...
      <div class="col-md-7">
        ...
        <div class="box box-primary">
          ...
          <!-- /.box-header -->
          <!-- form start -->
          <form role="form" method="POST" action="<?php echo e(route('estate-type.update')); ?>">
            <?php echo csrf_field(); ?>
              ...
              <?php endif; ?>
               <div class="form-group">
                  ...
                  <select class="form-control" name="type" id="type">                  
                    <option value="1" <?php echo e(old('type', $detail->type) == 1 ? "selected" : ""); ?>>Bán</option>
                      <option value="2" <?php echo e(old('type', $detail->type) == 2 ? "selected" : ""); ?>>Cho thuê</option>
                  </select>
                </div> 
               <!-- text input -->
              <div class="form-group">
            ...
            <div class="box-footer">
              ...
              <a class="btn btn-default btn-sm" class="btn btn-primary btn-sm" href="<?php echo e(route('estate-type.index')); ?>">Hủy</a>
            </div>
