...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="<?php echo e(route('info-seo.index')); ?>">Thông tin SEO</a></li>
  ...
  <section class="content">
    <a class="btn btn-default btn-sm" href="<?php echo e(route('info-seo.index')); ?>" style="margin-bottom:5px">Quay lại</a>
    <form role="form" method="POST" action="<?php echo e(route('info-seo.store')); ?>">
    <div class="row">
      <!-- left column -->
        ...
        <div class="box box-primary">
          ...
          <!-- /.box-header -->               
            ...
            <div class="box-body">
             ...
             <div class="form-group">
              ...
              <div class="form-group">
                ...
                <textarea class="form-control" rows="4" name="keywords" id="keywords"><?php echo e(old('keywords')); ?></textarea>
              </div>  
              <div class="form-group">
                <label>Custom text</label>
                <textarea class="form-control" rows="10" name="custom_text" id="custom_text"><?php echo e(old('custom_text')); ?></textarea>
              </div>
            ...
            <div class="box-footer">
              ...
              <a class="btn btn-default btn-sm" class="btn btn-primary btn-sm" href="<?php echo e(route('info-seo.index')); ?>">Hủy</a>
            </div>
