...
<div class="container">
	<article class="block-breadcrumb-page">
		<ul class="breadcrumb">	
			...
			<li><a href="<?php echo e(route('du-an')); ?>" title="Dự án">Dự án</a></li>
		...
		<ul class="nav nav-tabs nav-tabs-langding" id="nav-tabs-langding" role="tablist">
			<li role="presentation" >
				<p class="tabs-item-logo">
					<i class="icon">
						<img src="<?php echo e($detail->logo_url ? Helper::showImage($detail->logo_url) : URL::asset('backend/dist/img/no-image.jpg')); ?>" alt="<?php echo $detail->name; ?>">
					</i>
				</p>
			</li>
			<?php if(in_array(1, $tabArr)): ?>
			<li role="presentation" <?php if($tab_id == 1): ?> class="active" <?php endif; ?>>
				<a href="<?php echo e(route('detail-project', [$detail->slug])); ?>" >
					<i class="icon">
			...
			<?php endif; ?>
			<?php if(in_array(2, $tabArr)): ?>
		    <li role="presentation" <?php if($tab_id == 2): ?> class="active" <?php endif; ?>>
		    	<a href="<?php echo e(route('tab', [$detail->slug, 'vi-tri'])); ?>" >
		    		<i class="icon">
		    ...
		    <?php endif; ?>
		    <?php if(in_array(3, $tabArr)): ?>
		    <li role="presentation" <?php if($tab_id == 3): ?> class="active" <?php endif; ?>>
		    	<a href="<?php echo e(route('tab', [$detail->slug, 'tien-ich'])); ?>" >
		    		<i class="icon">
		    ...
		    <?php endif; ?>
		    <?php if(in_array(3, $tabArr)): ?>
		    <li role="presentation" <?php if($tab_id == 4): ?> class="active" <?php endif; ?>>
		    	<a href="<?php echo e(route('tab', [$detail->slug, 'thiet-ke'])); ?>" >
		    		<i class="icon">
		    ...
		    <?php endif; ?>
		    <?php if(in_array(5, $tabArr)): ?>
		    <li role="presentation" <?php if($tab_id == 5): ?> class="active" <?php endif; ?>>
		    	<a href="<?php echo e(route('tab', [$detail->slug, 'thanh-toan'])); ?>" >
		    		<i class="icon">
		    ...
		    <?php endif; ?>
		    <?php if(in_array(6, $tabArr)): ?>
		    <li role="presentation" <?php if($tab_id == 6): ?> class="active" <?php endif; ?>>
		    	<a href="<?php echo e(route('tab', [$detail->slug, 'brochure'])); ?>" >
		    		<p class="icon"><i class="fa fa-file-o" aria-hidden="true"></i></p>
		    		Brochure
	    		</a>
    		</li>
    		<?php endif; ?>
    		<?php if(in_array(7, $tabArr)): ?>
		    <li role="presentation" <?php if($tab_id == 7): ?> class="active" <?php endif; ?>>
		    	<a href="<?php echo e(route('tab', [$detail->slug, 'lien-he'])); ?>" >
		    		<i class="icon">
	...
	<div class="block-content" style="padding-bottom:50px">
		<div class="tab-content">
			<?php if(in_array(1, $tabArr) && $tab_id != 7): ?>
			<div role="tabpanel" class="tab-pane fade in active" id="About">
				<?php if($detailTab): ?>
				<div class="page-block">
					<h2 class="page-title"><?php echo e($detailTab->title); ?></h2>
			...
			<?php if(in_array(7, $tabArr) && $tab_id == 7): ?>
			<div role="tabpanel" class="tab-pane fade in active" id="Contact">
				<h2 class="page-title">Liên Hệ</h2>
				<div class="row">
					<div class="col-sm-6 col-xs-12">
						<img class="project-logo-contact" src="<?php echo e($detail->logo_url ? Helper::showImage($detail->logo_url) : URL::asset('backend/dist/img/no-image.jpg')); ?>" alt="<?php echo e($detail->name); ?>">
					...
					<div class="col-sm-6 col-xs-12">
		                ...
		                <?php endif; ?>
						<form action="<?php echo e(route('project-contact')); ?>" method="POST" class="form-horizontal block-contact-form-tab">
							...
							<input type="hidden" name="return_url" value="<?php echo e(url()->current()); ?>">
                  			...
                  			<div class="form-group group">
                  				<textarea rows="5" name="content" placeholder=""><?php echo e(old('content')); ?></textarea>
                  				<span class="highlight"></span>
                  				<span class="bar"></span>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.landing', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>