    ...
    <div class="col-md-12">
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <form class="form-inline" role="form" method="GET" action="<?php echo e(route('contact.index')); ?>" id="frmContact">  <div class="form-group">
              <label for="name">Dự án :</label>
              <select class="form-control" name="project_id" id="project_id">
                <option value="">--Tất cả--</option>
                
                <?php foreach($proList as $pro): ?>
                <option value="<?php echo e($pro->id); ?>" <?php echo e($project_id == $pro->id ? "selected" : ""); ?>><?php echo e($pro->name); ?></option> 
                <?php endforeach; ?>
              </select>
            </div>                                              
            ...
            <?php if( $items->count() > 0 ): ?>
              ...
              <tr id="row-<?php echo e($item->id); ?>">
                ...
                <td style="white-space:nowrap">                                  
                  ...
                  <a onclick="return callDelete('<?php echo e($item->email); ?>','<?php echo e(route( 'contact.destroy', [ 'id' => $item->id ])); ?>');" class="btn btn-danger btn-sm"><span class="glyphicon glyphicon-trash"></span></a>
