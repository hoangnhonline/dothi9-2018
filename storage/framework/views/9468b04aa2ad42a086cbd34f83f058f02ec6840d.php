...
<div class="content-wrapper">
  ...
  <section class="content">
    <a class="btn btn-default btn-sm " href="<?php echo e(route('tag.index', ['type' => $type])); ?>" style="margin-bottom:5px">Quay lại</a>
              ...
              <?php endif; ?>
                <div class="form-group">
                  ...
                  <select class="form-control" name="type" id="type">                                
                    <option value="1" <?php echo e(1 ==  old('type', $type) ? "selected" : ""); ?>>BĐS</option>
                    <option value="2" <?php echo e(2 ==  old('type', $type) ? "selected" : ""); ?>>Bài viết</option>
                    <option value="3" <?php echo e(3 ==  old('type', $type) ? "selected" : ""); ?>>Tiện ích xung quanh</option>
                  </select>
                </div>
                <div class="form-group" id="div_tien_ich" <?php if(old('type') != 3 ): ?> style="display:none" <?php endif; ?>>
                  <label for="email">Quận</label>
                    <select class="form-control" name="district_id" id="district_id" data-live-search="true">
                        ...
                        <?php echo e(old('district_id') == $value->id ? "selected" : ""); ?>                           
