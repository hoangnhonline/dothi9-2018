...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <a class="btn btn-primary btn-sm" href="<?php echo e(route('danh-muc', $detail->slug )); ?>" target="_blank" style="margin-top:-6px"><i class="fa fa-eye" aria-hidden="true"></i> Xem</a>
    <form role="form" method="POST" action="<?php echo e(route('pages.update')); ?>">
    <div class="row">
      <!-- left column -->
