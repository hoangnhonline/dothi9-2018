...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <form role="form" method="POST" action="<?php echo e(route('landing-projects.store')); ?>">
    <div class="row">
      <!-- left column -->
      ...
      <div class="col-md-8">
        ...
        <div class="box box-primary">
          ...
          <!-- /.box-header -->               
            ...
            <div class="box-body">
              ...
              <?php endif; ?>                     
                ...
                <div class="form-group" style="margin-top:10px;margin-bottom:10px">  
                  ...
                  <div class="col-md-9">
                    <img id="thumbnail_logo" src="<?php echo e(old('logo_url') ? Helper::showImage(old('logo_url')) : URL::asset('backend/dist/img/img.png')); ?>" class="img-thumbnail" width="145" height="145">
                ...
                <div class="form-group">
                  ...
                  <?php $i = 0; ?>
                    ...
                    <li style="list-style:none">
                      ...
                      <?php echo e(old('tab') && in_array($tab->id, old('tab')) ? "checked" : ""); ?>
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" rows="3" name="address" id="address"><?php echo e(old('address')); ?></textarea>
                </div>
                <div class="form-group">
                  <label>Địa chỉ liên hệ</label>
                  <textarea class="form-control" rows="3" name="address_contact" id="address_contact"><?php echo e(old('address_contact')); ?></textarea>
                </div>  
                <div class="form-group">                  
                  <label>Điện thoại</label>                  
                  <input type="text" class="form-control" name="phone_contact" id="phone_contact" value="<?php echo e(old('phone_contact')); ?>">
                </div>  
                <div class="form-group">                  
                  <label>Email</label>                  
                  <input type="text" class="form-control" name="email_contact" id="email_contact" value="<?php echo e(old('email_contact')); ?>">
                </div>             
            </div>          
            ...
            <input type="hidden" name="logo_url" id="logo_url" value="<?php echo e(old('logo_url')); ?>"/>          
