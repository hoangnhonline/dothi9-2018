            ...
            <div class="box-body">
              ...
              <?php endif; ?>              
                 <div class="form-group" style="margin-top:10px;margin-bottom:10px">  
                  ...
                  <div class="col-md-9">
                    <img id="thumbnail_image" src="<?php echo e($detailBanner->image_url ? Helper::showImage($detailBanner->image_url) : URL::asset('backend/dist/img/img.png')); ?>" class="img-thumbnail" width="145" height="85">
