...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="<?php echo e(route('estate-type.index')); ?>?type=<?php echo e($type); ?>">Danh mục</a></li>
  ...
  <section class="content">
    <a class="btn btn-default btn-sm" href="<?php echo e(route('estate-type.index')); ?>?type=<?php echo e($type); ?>" style="margin-bottom:5px">Quay lại</a>
    <form role="form" method="POST" action="<?php echo e(route('estate-type.store')); ?>">
    <div class="row">
      <!-- left column -->
        ...
        <div class="box box-primary">
          ...
          <!-- /.box-header -->               
            ...
            <div class="box-footer">
              ...
              <a class="btn btn-default btn-sm" class="btn btn-primary btn-sm" href="<?php echo e(route('estate-type.index')); ?>?type=<?php echo e($type); ?>">Hủy</a>
            </div>
