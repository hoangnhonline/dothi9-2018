				...
				<article class="block-post-news">
	                ...
	                <?php endif; ?>
						<div class="block-post-news">
							...
							<form method="POST" action="<?php echo e(route('post-ky-gui')); ?>" class="block-hover-selectpicker">
								<?php echo csrf_field(); ?>
								...
								<div class="form-horizontal">
									<div class="form-group">
										...
										<div class="col-sm-9">
									  		<input type="radio" name="type" value="1" class="radio_type" id="type_1" <?php echo e(old('type', $type) == 1 ? "checked" : ""); ?>>
									  		<label for="type_1">BĐS bán</label>
									  		&nbsp;&nbsp;&nbsp;
									  		<input type="radio" name="type" value="2" class="radio_type" id="type_2" <?php echo e(old('type', $type) == 2 ? "checked" : ""); ?>>
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
									  		<select class="selectpicker form-control" name="estate_type_id" id="estate_type_id">
					                            ...
					                            <?php echo e(old('estate_type_id') == $value->id ? "selected" : ""); ?>                           
									...
									<div class="form-group text-center">
										...
										<button type="button" onclick="location.href='<?php echo e(route('home')); ?>'" class="btn btn-primary"><i class="fa fa-times"></i> HỦY BỎ</button>
									</div><!-- /form-group -->
								</div>
							</form>
						</div>
...
<input type="hidden" id="route_upload_tmp_image_multiple" value="<?php echo e(route('image.tmp-upload-multiple-fe')); ?>">
  <style>
