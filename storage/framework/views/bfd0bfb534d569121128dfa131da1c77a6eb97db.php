...
<div class="content-wrapper">
  ...
  <section class="content">
    <a class="btn btn-default btn-sm" href="<?php echo e(route('product.index', ['estate_type_id' => $estate_type_id, 'type' => $type])); ?>" style="margin-bottom:5px">Quay lại</a>    
        ...
        <div class="box box-primary">
          ...
          <!-- /.box-header -->               
                  ...
                  <div class="tab-content">
                      ...
                      <div class="form-group col-md-4 pleft-5">
                          <label for="email">Loại <span class="red-star">*</span></label>
                            <select class="form-control" name="type" id="type">
                                <option value="1" <?php echo e(old('type', $type) == 1 ? "selected" : ""); ?>>Bán</option>
                                <option value="2" <?php echo e(old('type', $type) == 2 ? "selected" : ""); ?>>Cho thuê</option>
                            </select>
                        </div>
                        <div class="form-group col-md-4 none-padding">
                          ...
                          <select class="form-control" name="estate_type_id" id="estate_type_id">
                            ...
                            <?php echo e(old('estate_type_id', $estate_type_id) == $value->id ? "selected" : ""); ?>
                        ...
                        <div class="form-group col-md-4">
                          ...
                          <select class="form-control" name="cate_id" id="cate_id">
                            ...
                            <option value="<?php echo e($value->id); ?>"
                            <?php echo e(old('cate_id') == $value->id ? "selected" : ""); ?>                           
                        ...
                        <div class="form-group col-md-6  pleft-5">
                          <label for="email">Quận <span class="red-star">*</span></label>
                            <select class="form-control" name="district_id" id="district_id">
                                ...
                                <option value="<?php echo e($value->id); ?>"
                                <?php echo e(old('district_id', $district_id) == $value->id ? "selected" : ""); ?>                           
                        ...
                        <div class="form-group col-md-6 none-padding">
                          ...
                          <select class="form-control" name="ward_id" id="ward_id">
                            ...
                            <option value="<?php echo e($value->id); ?>"
                            <?php echo e(old('ward_id') == $value->id ? "selected" : ""); ?>                           
                        ...
                        <div class="form-group col-md-6  pleft-5">
                          <label for="email">Đường <span class="red-star">*</span></label>
                            <select class="form-control" name="street_id" id="street_id">
                                ...
                                <option value="<?php echo e($value->id); ?>"
                                <?php echo e(old('street_id') == $value->id ? "selected" : ""); ?>                           
                        ...
                        <div class="form-group col-md-6 none-padding">
                          ...
                          <select class="form-control" name="project_id" id="project_id">
                            ...
                            <option value="<?php echo e($value->id); ?>"
                            <?php echo e(old('project_id') == $value->id ? "selected" : ""); ?>
                        ...
                        <div class="form-group col-md-6 none-padding pleft-5" >                  
                            ...
                            <select class="form-control" name="price_unit_id" id="price_unit_id">
                              ...
                              <option value="<?php echo e($value->id); ?>"
                              <?php echo e(old('price_unit_id') == $value->id ? "selected" : ""); ?>                           
                          ...
                          <label for="email">Khoảng giá<span class="red-star">*</span></label>
                            <select class="form-control" name="price_id" id="price_id">
                              <option value="">--Chọn--</option>
                                ...
                                <option value="<?php echo e($value->id); ?>"
                                <?php echo e(old('price_id') == $value->id ? "selected" : ""); ?>
                        ...
                        <div class="form-group col-md-6 none-padding">
                          ...
                          <select class="form-control" name="area_id" id="area_id">
                            ...
                            <option value="<?php echo e($value->id); ?>"
                            <?php echo e(old('area_id') == $value->id ? "selected" : ""); ?>
                        ...
                        <div class=" form-group col-md-4 none-padding pleft-5">
                          ...
                          <input type="text" class="form-control" name="front_face" id="front_face" value="<?php echo e(old('front_face')); ?>">                        
                        </div>
                        <div class="form-group col-md-4 none-padding pleft-5">
                          <label>Đường trước nhà</label>                  
                          <input type="text" class="form-control" name="street_wide" id="street_wide" value="<?php echo e(old('street_wide')); ?>">                        
                        </div>
                        <div class="form-group col-md-3 none-padding">
                          <label>Số tầng</label>                  
                          <input type="text" class="form-control" name="no_floor" id="no_floor" value="<?php echo e(old('no_floor')); ?>">                        
                        </div>
                        ...
                        <div class="form-group col-md-3 none-padding pleft-5">
                          ...
                          <select class="form-control" name="direction_id" id="direction_id">
                            <?php if( $directionArr->count() > 0): ?>
                              ...
                              <option value="<?php echo e($value->id); ?>" <?php echo e(old('direction_id') == $value->id  ? "selected" : ""); ?>><?php echo e($value->name); ?></option>
                              <?php endforeach; ?>
                            <?php endif; ?>
                          </select>                       
                        </div>
                        ...
                        <div class="form-group col-md-4 none-padding" >
                            <div class="checkbox">
                              <label>
                                <input type="checkbox" name="cart_status" value="1" <?php echo e(old('cart_status') == 1 || old('cart_status') == NULL ? "checked" : ""); ?>>
                                <?php echo e($type == 1 ? "Chưa bán" : "Còn trống"); ?>
                        ...
                        <div class="form-group col-md-4 none-padding" >
                            <div class="checkbox">
                              <label>
                                <input type="checkbox" name="cart_status" value="2" <?php echo e(old('cart_status') == 2 ? "checked" : ""); ?>>
                                <?php echo e($type == 1 ? "Đã bán" : "Đã thuê"); ?>
                        ...
                        <div class="form-group col-md-4 none-padding" >
                            <div class="checkbox">
                              <label>
                                <input type="checkbox" name="cart_status" value="3" <?php echo e(old('cart_status') == 3 ? "checked" : ""); ?>>
                                Đã cọc
                              </label>
                            </div>
                        </div>
                    ...
                    <div role="tabpanel" class="tab-pane" id="lien-he">
                        <div class="form-group col-md-6 " >                  
                            ...
                            <input type="text" class="form-control" name="contact_name" id="contact_name" value="<?php echo e(old('contact_name')); ?>">
                        </div>
                        <div class="form-group col-md-6 none-padding pleft-5" >                  
                            <label>Địa chỉ</label>
                            <input type="text" class="form-control" name="contact_address" id="contact_address" value="<?php echo e(old('contact_address')); ?>">
                        </div>                        
                        <div class="form-group col-md-6 " >                  
                            <label>Điện thoại</label>
                            <input type="text" class="form-control" name="contact_phone" id="contact_phone" value="<?php echo e(old('contact_phone')); ?>">
                        </div>
                        <div class="form-group col-md-6 none-padding pleft-5" >                  
                            <label>Di động <span class="red-star">*</span></label>
                            <input type="text" class="form-control" name="contact_mobile" id="contact_mobile" value="<?php echo e(old('contact_mobile')); ?>">
                        </div>
                        <div class="form-group col-md-12 " >                  
                            <label>Email</label>
                            <input type="text" class="form-control" name="contact_email" id="contact_email" value="<?php echo e(old('contact_email')); ?>">
                        </div>
                        <div class="clearfix"></div>
                     </div><!--end lien he -->                  
            ...
            <div class="box-footer">
              ...
              <a class="btn btn-default btn-sm" class="btn btn-primary btn-sm" href="<?php echo e(route('product.index', ['estate_type_id' => $estate_type_id, 'type' => $type])); ?>">Hủy</a>
            </div>
...
<input type="hidden" id="route_get_tien_ich" value="<?php echo e(route('product.ajax-get-tien-ich')); ?>">
<style type="text/css">
 ...
 $('#contentTag #name').change(function(){
    ...
    $(document).ready(function(){
      ...
      $('#type, #estate_type_id').change(function(){
        ...
        var url ="<?php echo e(route('product.create')); ?>?type=" + $('#type').val();
